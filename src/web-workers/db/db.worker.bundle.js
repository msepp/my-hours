...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_environments_environment__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__db_messages__ = __webpack_require__(126);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__db_schema__ = __webpack_require__(127);
...
var db = new __WEBPACK_IMPORTED_MODULE_2__db_schema__["a" /* HoursDB */]();
...
var log = function () {
    ...
    if (__WEBPACK_IMPORTED_MODULE_0_environments_environment__["a" /* environment */].workerDebug) {
        console.log.apply(console, ['[worker]'].concat(args));
    }
};
// replyTo posts a reply to the given input message. Reply data is set from the
// response object.
function replyTo(msg, response) {
    log("response for " + msg.id + "/" + msg.type, response);
    postMessage(__assign({ id: msg.id }, response));
}
...
onmessage = function (event) {
    ...
    log('received', msg);
    switch (msg.type) {
        case __WEBPACK_IMPORTED_MODULE_1__db_messages__["a" /* DBMessageType */].ActiveTask:
            db.getActiveTask()
                .then(function (task) { return replyTo(msg, { data: task }); })
                .catch(function (e) { return replyTo(msg, { error: e }); });
            break;
        case __WEBPACK_IMPORTED_MODULE_1__db_messages__["a" /* DBMessageType */].DeleteGroup:
            db.deleteGroup(msg.groupId)
                .then(function () { return replyTo(msg, {}); })
                .catch(function (e) { return replyTo(msg, { error: e }); });
            break;
        case __WEBPACK_IMPORTED_MODULE_1__db_messages__["a" /* DBMessageType */].DeleteTask:
        ...
        case __WEBPACK_IMPORTED_MODULE_1__db_messages__["a" /* DBMessageType */].InsertGroup:
            db.insertGroup(msg.group)
                ...
                .catch(function (e) { return replyTo(msg, { error: e }); });
            break;
        case __WEBPACK_IMPORTED_MODULE_1__db_messages__["a" /* DBMessageType */].InsertTask:
            db.insertTask(msg.task)
                .then(function (newId) { return replyTo(msg, { data: newId }); })
                .catch(function (e) { return replyTo(msg, { error: e }); });
            break;
        case __WEBPACK_IMPORTED_MODULE_1__db_messages__["a" /* DBMessageType */].ReadGroups:
            db.readGroups()
                .then(function (groups) { return replyTo(msg, { data: groups }); })
                .catch(function (e) { return replyTo(msg, { error: e }); });
            break;
        case __WEBPACK_IMPORTED_MODULE_1__db_messages__["a" /* DBMessageType */].CreateReport:
            db.createReport(msg.options)
                .then(function (report) { return replyTo(msg, { data: report }); })
                .catch(function (e) { return replyTo(msg, { error: e }); });
            break;
        case __WEBPACK_IMPORTED_MODULE_1__db_messages__["a" /* DBMessageType */].ReadTasks:
            db.readTasks()
                .then(function (tasks) { return replyTo(msg, { data: tasks }); })
                .catch(function (e) { return replyTo(msg, { error: e }); });
            break;
        case __WEBPACK_IMPORTED_MODULE_1__db_messages__["a" /* DBMessageType */].StartTask:
        ...
        case __WEBPACK_IMPORTED_MODULE_1__db_messages__["a" /* DBMessageType */].StopTask:
            ...
            break;
        case __WEBPACK_IMPORTED_MODULE_1__db_messages__["a" /* DBMessageType */].UpdateGroup:
            db.updateGroup(msg.group)
                .then(function (group) { return replyTo(msg, { data: group }); })
                .catch(function (e) { return replyTo(msg, { error: e.message }); });
            break;
        case __WEBPACK_IMPORTED_MODULE_1__db_messages__["a" /* DBMessageType */].UpdateTask:
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return DBMessageType; });
/* unused harmony export DBMessageActiveTask */
/* unused harmony export DBMessageCreateReport */
/* unused harmony export DBMessageDeleteGroup */
/* unused harmony export DBMessageDeleteTask */
/* unused harmony export DBMessageInsertGroup */
/* unused harmony export DBMessageInsertTask */
/* unused harmony export DBMessageReadGroups */
/* unused harmony export DBMessageReadTasks */
/* unused harmony export DBMessageStartTask */
...
var DBMessageType;
(function (DBMessageType) {
    DBMessageType["DeleteGroup"] = "delete.group";
    DBMessageType["InsertGroup"] = "insert.group";
    DBMessageType["ReadGroups"] = "read.groups";
    DBMessageType["UpdateGroup"] = "update.group";
    DBMessageType["ActiveTask"] = "active.task";
    DBMessageType["DeleteTask"] = "delete.task";
    DBMessageType["InsertTask"] = "insert.task";
    DBMessageType["ReadTasks"] = "read.tasks";
    DBMessageType["StartTask"] = "start.task";
...
// to a response.
var DBIdableMessage = /** @class */ (function () {
    function DBIdableMessage() {
        this.id = nextId();
    }
    return DBIdableMessage;
}());
var DBMessageActiveTask = /** @class */ (function (_super) {
    __extends(DBMessageActiveTask, _super);
    function DBMessageActiveTask() {
        var _this = _super.call(this) || this;
        _this.type = DBMessageType.ActiveTask;
        return _this;
    }
    return DBMessageActiveTask;
}(DBIdableMessage));

var DBMessageCreateReport = /** @class */ (function (_super) {
    __extends(DBMessageCreateReport, _super);
    function DBMessageCreateReport(options) {
        var _this = _super.call(this) || this;
        _this.options = options;
        _this.type = DBMessageType.CreateReport;
        return _this;
    }
    return DBMessageCreateReport;
}(DBIdableMessage));

var DBMessageDeleteGroup = /** @class */ (function (_super) {
    __extends(DBMessageDeleteGroup, _super);
    function DBMessageDeleteGroup(groupId) {
        var _this = _super.call(this) || this;
        _this.groupId = groupId;
        _this.type = DBMessageType.DeleteGroup;
        return _this;
    }
    return DBMessageDeleteGroup;
}(DBIdableMessage));

var DBMessageDeleteTask = /** @class */ (function (_super) {
    __extends(DBMessageDeleteTask, _super);
    function DBMessageDeleteTask(taskId) {
        var _this = _super.call(this) || this;
        _this.taskId = taskId;
        _this.type = DBMessageType.DeleteTask;
        return _this;
    }
    return DBMessageDeleteTask;
}(DBIdableMessage));

var DBMessageInsertGroup = /** @class */ (function (_super) {
    __extends(DBMessageInsertGroup, _super);
    function DBMessageInsertGroup(group) {
        var _this = _super.call(this) || this;
        _this.group = group;
        _this.type = DBMessageType.InsertGroup;
        return _this;
    }
    return DBMessageInsertGroup;
}(DBIdableMessage));

var DBMessageInsertTask = /** @class */ (function (_super) {
    __extends(DBMessageInsertTask, _super);
    function DBMessageInsertTask(task) {
        var _this = _super.call(this) || this;
        _this.task = task;
        _this.type = DBMessageType.InsertTask;
        return _this;
    }
    return DBMessageInsertTask;
}(DBIdableMessage));

var DBMessageReadGroups = /** @class */ (function (_super) {
    __extends(DBMessageReadGroups, _super);
    function DBMessageReadGroups() {
        var _this = _super.call(this) || this;
        _this.type = DBMessageType.ReadGroups;
        return _this;
    }
    return DBMessageReadGroups;
}(DBIdableMessage));

var DBMessageReadTasks = /** @class */ (function (_super) {
    __extends(DBMessageReadTasks, _super);
    function DBMessageReadTasks() {
        var _this = _super.call(this) || this;
        _this.type = DBMessageType.ReadTasks;
        return _this;
    }
    return DBMessageReadTasks;
}(DBIdableMessage));

var DBMessageStartTask = /** @class */ (function (_super) {
    __extends(DBMessageStartTask, _super);
    function DBMessageStartTask(task) {
        var _this = _super.call(this) || this;
        _this.task = task;
        _this.type = DBMessageType.StartTask;
        return _this;
    }
    return DBMessageStartTask;
}(DBIdableMessage));
...
var DBMessageStopTask = /** @class */ (function (_super) {
    ...
    return DBMessageStopTask;
}(DBIdableMessage));

var DBMessageUpdateGroup = /** @class */ (function (_super) {
    __extends(DBMessageUpdateGroup, _super);
    function DBMessageUpdateGroup(group) {
        var _this = _super.call(this) || this;
        _this.group = group;
        _this.type = DBMessageType.UpdateGroup;
        return _this;
    }
    return DBMessageUpdateGroup;
}(DBIdableMessage));

var DBMessageUpdateTask = /** @class */ (function (_super) {
    __extends(DBMessageUpdateTask, _super);
    function DBMessageUpdateTask(task) {
        var _this = _super.call(this) || this;
        _this.task = task;
        _this.type = DBMessageType.UpdateTask;
        return _this;
    }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_environments_environment__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_dexie__ = __webpack_require__(128);
...
var HoursDB = /** @class */ (function (_super) {
    __extends(HoursDB, _super);
    function HoursDB() {
        var _this = _super.call(this, DBName) || this;
        _this._log('init begin');
        // Open database
        ...
        _this.transaction('rw', _this.settings, function () {
    ...
    HoursDB.prototype._log = function () {
        var args = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            args[_i] = arguments[_i];
        }
        if (__WEBPACK_IMPORTED_MODULE_0_environments_environment__["a" /* environment */].workerDebug) {
            console.log.apply(console, ['[db.hours]'].concat(args));
        }
    };
    ...
    HoursDB.prototype.deleteGroup = function (id) {
        var _this = this;
        this._log('delete.group', id);
        return this.transaction('rw', this.groups, this.tasks, function () {
            // First delete the group
            _this.groups.delete(id);
            var plist = [];
            _this.tasks.where('groups').equals(id).each(function (t) {
                var gidx = t.groups.indexOf(id);
                var ng = t.groups.slice();
                ng.splice(gidx, 1);
                plist.push(_this.tasks.update(t.id, { groups: ng }));
            });
            return __WEBPACK_IMPORTED_MODULE_1_dexie__["a" /* default */].Promise.all(plist);
        });
    };
    // deleteTask deletes a single task from the database identified by id.
    // Returns a promise that resolves when delete is finished or has failed.
    HoursDB.prototype.deleteTask = function (id) {
        this._log('delete.task', id);
        return this.tasks.delete(id);
    };
    // getActiveTask returns the currently active task or null if no task is active
    HoursDB.prototype.getActiveTask = function () {
        var _this = this;
        return this.transaction('r', this.settings, function () {
            return _this.settings.get(Setting.ActiveTask).then(function (s) {
                _this._log('read active task: ', s);
                if (!s) {
                    return undefined;
                }
                else {
    ...
    HoursDB.prototype.insertGroup = function (group) {
        ...
        return new Promise(function (resolve, reject) {
            _this.groups.put(group)
                .then(function (id) { return resolve(__assign({}, group, { id: id })); })
    ...
    HoursDB.prototype.insertTask = function (task) {
        ...
        return new Promise(function (resolve, reject) {
            _this.tasks.put(task)
                .then(function (id) { return resolve(__assign({}, task, { id: id })); })
                .catch(function (reason) { return reject(reason); });
        });
    };
    // readGroups reads all group entries from the database.
    // Returns a promise that resolves with the found groups.
    HoursDB.prototype.readGroups = function () {
        var _this = this;
        this._log('read.groups');
        return new Promise(function (resolve, reject) {
            var res = [];
            _this.groups
                .each(function (g) { return res.push(g); })
    ...
    HoursDB.prototype.createReport = function (options) {
        ...
        if (options.groups.length > 0) {
            ...
            filterPromise = this.tasks.where('groups').anyOf(options.groups).toArray().then(function (tasks) {
                taskFilter = tasks.map(function (t) { return t.id; });
                if (options.tasks.length > 0) {
                    taskFilter = taskFilter.concat(options.tasks);
                }
            });
        }
        else {
        ...
        return filterPromise.then(function () {
            _this._log('filter tasks:', taskFilter);
            ...
            options.start = __WEBPACK_IMPORTED_MODULE_2_moment__(options.start).startOf('day').format(TimestampFormat) + 'Z';
            options.end = __WEBPACK_IMPORTED_MODULE_2_moment__(options.end).endOf('day').format(TimestampFormat) + 'Z';
            return _this.history.where('start').between(options.start, options.end, true, true).filter(function (work) {
                if (taskFilter === null) {
                    return true;
                }
            ...
            var tempd = options.start;
            _this._log('start', tempd);
            while (tempd <= options.end) {
                ...
                tempd = __WEBPACK_IMPORTED_MODULE_2_moment__(tempd).add(1, 'day').format(TimestampFormat) + 'Z';
                _this._log('tempd: ', tempd);
            }
            _this._log('days:', days);
            result.map(function (w) { return new Work(w); }).forEach(function (w) {
                var day = w.start.split('T')[0];
                ddata = days.find(function (d) {
                    _this._log('compare', d, day);
                    return d.day === day;
                });
                _this._log(ddata);
    ...
    HoursDB.prototype.readTasks = function () {
        var _this = this;
    ...
    HoursDB.prototype.updateGroup = function (group) {
        var _this = this;
        this._log('update.group', group);
        return this.transaction('rw', this.groups, function () {
            return _this.groups.update(group.id, __assign({}, group)).then(function () {
                return _this.groups.get(group.id);
            }).then(function (g) {
                return g;
            });
        });
    ...
    HoursDB.prototype.updateTask = function (task) {
        var _this = this;
        this._log('update.task', task);
        return this.transaction('rw', this.tasks, function () {
            return _this.tasks.update(task.id, __assign({}, task)).then(function () {
                return _this.tasks.get(task.id);
            }).then(function (g) {
                return g;
            });
        });
...
/***/ })
/******/ ]);
//# sourceMappingURL=db.worker.bundle.js.map